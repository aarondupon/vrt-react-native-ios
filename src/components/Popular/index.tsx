...
const SvgComponent = props => (
    <Svg width={225} height={409} {...props} style={{position:'absolute',right:0,top:'64%'}}>
      <Svg.G fill="none" fillRule="evenodd">
        <Svg.Path fill="#FFF" d="M0 409h225V0H0z" />
        <Text
        ...
        <Svg.Path d="M25 157.5h177H25z" fill="#E6E6E6" />
        <Svg.Path d="M25 157.5h177" stroke="#E6E6E6" />
        <Svg.Path d="M25 256.5h177H25z" fill="#E6E6E6" />
        <Svg.Path d="M25 256.5h177" stroke="#E6E6E6" />
        <Svg.Path
          fill="#5DFC71"
